...
Скетч использует 32376 байт (12%) памяти устройства. Всего доступно 253952 байт.
Глобальные переменные используют 3441 байт (42%) динамической памяти, 
оставляя 4751 байт для локальных переменных. Максимум: 8192 байт.
/*****************************************************************************\
